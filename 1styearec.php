...
$_SESSION['dyna']="1styearec";$_SESSION['nn']=2;
?>
...
if(!empty($msg))
{
	...
	$previous = mysql_query("SELECT message FROM 1styearec WHERE message='$fmsg' ORDER BY msgid DESC LIMIT 0 , 6");
	while($p=mysql_fetch_assoc($previous))
	{$fg=1;}
	if($fg==0)
	{mysql_query("INSERT INTO `1styearec` VALUES ('' ,'$user','$fmsg','$time','0')");
	mysql_query("UPDATE notify SET time = '$time' WHERE notify.sl = 2");$file=fopen("recent.txt","w");
	$val=$user.'<sup>&nbsp;&nbsp;&nbsp;to&nbsp;First year EC&nbsp;&nbsp;</sup><br><br>'.$fmsg;
	fputs($file,$val);
	fclose($file);}
	}
...
<?php  echo "<script type='text/javascript'  >recur();</script>" ;echo " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hello ".$_SESSION['fullname']; echo("!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");?>
  <a href="logdout.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('logout','','logoff2.jpg',1)"><img src="logoff.jpg" name="logout" width="70" height="57" border="0" id="logout"  align="right"/></a>&nbsp;&nbsp;
...
if(!$start)
$start=0;
$count=mysql_num_rows(mysql_query("SELECT * FROM 1styearec"));
...
echo $s['fullname'].":<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$s['message']."<sub><br><br>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;on&nbsp;&nbsp; ".$s['datetime']."  , ".$show."</sub><br/><hr align=left  width=680 size=2>";
			...
			echo "page:";
	if(!($start<=0))		
	echo "<a href='1styearec.php?start=$prev'>|prev|&nbsp;</a>";
	
	$j=1;
	for($z=0;$z<$count;$z=$z+$perpage,++$j)
	echo "<a href='1styearec.php?start=$z'>|$j|&nbsp;</a>";
	if(!($start>=$count-$perpage))
	echo "<a href='1styearec.php?start=$next'>&nbsp;|next|</a>";?>    <br />
    &nbsp;</td>
	 ...
	 $zzz=0;
	$bbirth=mysql_query("SELECT fullname FROM userdata WHERE fordob='$dd' AND batch='2011' AND branch='EC'");
